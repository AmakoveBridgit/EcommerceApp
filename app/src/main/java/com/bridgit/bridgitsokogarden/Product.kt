...
class ProductAdapter(private val originalList:  List<Product>) :
    RecyclerView.Adapter<ProductAdapter.ProductViewHolder>() {

    private var displayList: MutableList<Product> = originalList.toMutableList()
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        val imageUrl = "https://caydenmayavi.pythonanywhere.com/static/images/${product.product_photo}"
...
override fun getItemCount(): Int = displayList.size
    ...
    // Function to apply filter based on search query
